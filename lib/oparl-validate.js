...
(function (window, document) {
    ...
    OParl.Validator = {
        ...
        validateObjectList: function (orig, type, name, req, subtype, included) {
            var that = this;
            ...
            return new Promise(function(resolve, reject) {
                ...
                if (!o) {
                    OParl.Validator.result.push("Warning: No data found for " + type + " property '" + name + "'");
                ...
                o.get()
                    .then(objectList => {
                        ...
                        objectList.forEach(element => {
                            l.push(that[test](element, included));
                        });
        ...
        isChecked: function(o) {
            return (OParl.Validator.checked[o.id]?1:0);
        },

        checkDone: function(o) {
            OParl.Validator.checked[o.id] = true;
        },
        ...
        validateSystem: function(o) {
            ...
            var p = new Promise(function(resolve, reject) { 
                ...
                console.log("Validate system object ...");
                ...
                that.validateDateTime(o, 'System', 'created', true);
                that.validateDateTime(o, 'System', 'modified', true);
        ...
        validateBody: function(o) {
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    console.log("Validate body object " + o.id + " ...");
                    ...
                    that.validateDateTime(o, 'Body', 'created', true);
                    that.validateDateTime(o, 'Body', 'modified', true);
                    ...
                    l.push(that.validateObjectList(o, 'Body', 'legislativeTerm', true, 'LegislativeTerm', true));
        ...
        validateLegislativeTerm: function(o, included) {
            var that = this;
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    console.log("Validate legislative term object " + o.id + " ...");
                    ...
                    that.validateDateTime(o, 'LegislativeTerm', 'created', (!included || that.version == '1.1'));
                    that.validateDateTime(o, 'LegislativeTerm', 'modified', (!included || that.version == '1.1'));
        ...
        validateLocation: function(o, included) {
            var that = this;
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    console.log("Validate location object " + o.id + " ...");

                    that.validateType(o, 'Location');

                    that.validateUrl(o, 'Location', 'id');
                    
                    that.validateDateTime(o, 'Location', 'created', (!included || that.version == '1.1'));
                    that.validateDateTime(o, 'Location', 'modified', (!included || that.version == '1.1'));
        ...
        validateOrganization: function(o) {
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    that.validateDateTime(o, 'Organization', 'created', true);
                    that.validateDateTime(o, 'Organization', 'modified', true);

                    that.checkDone(o);

                    var l = [];

                    if (o.location) l.push(that.validateLocation(o.location, true));
        ...
        validatePerson: function(o) {
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    console.log("Validate Person object " + o.id + " ...");

                    that.validateType(o, 'Person');

                    that.validateUrl(o, 'Person', 'id');
                    
                    that.validateDateTime(o, 'Person', 'created', true);
                    that.validateDateTime(o, 'Person', 'modified', true);
        ...
        validateMeeting: function(o) {
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    console.log("Validate Meeting object " + o.id + " ...");
                    ...
                    that.validateDateTime(o, 'Meeting', 'created', true);
                    that.validateDateTime(o, 'Meeting', 'modified', true);
                    ...
                    // if (o.location) l.push(that.validateLocation(o.location, true));
                    // if (o.invitation) l.push(that.validateFile(o.invitation, true));

                    // if (o.resultsProtocol) l.push(that.validateFile(o.resultsProtocol, true));
                    // if (o.verbatimProtocol) l.push(that.validateFile(o.verbatimProtocol, true));
        ...
        validatePaper: function(o) {
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    console.log("Validate Paper object " + o.id + " ...");
                    ...
                    if (o.location) l.push(that.validateLocation(o.location, true));
                    if (o.mainFile) l.push(that.validateFile(o.mainFile, true));
                    
                    l.push(that.validateObjectList(o, 'Paper', 'auxiliaryFile', false, 'File', true));
                    ...
                    l.push(that.validateObjectList(o, 'Paper', 'consultation', false, 'Consultation', true));
        ...
        validateMembership: function(o) {
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    console.log("Validate Membership object " + o.id + " ...");
                    ...
                    that.validateDateTime(o, 'Membership', 'created', true);
                    that.validateDateTime(o, 'Membership', 'modified', true);
        ...
        validateFile: function(o, included) {
            var that = this;
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    console.log("Validate File object " + o.id + " ...");
                    ...
                    that.validateDateTime(o, 'File', 'created', (!included || that.version == '1.1'));
                    that.validateDateTime(o, 'File', 'modified', (!included || that.version == '1.1'));

                    that.checkDone(o);

                    var l = [];

                    if (o.masterFile) l.push(that.validateFile(o.masterFile, true));

                    l.push(that.validateObjectList(o, 'File', 'derivativeFile', !included, 'File'));
                    l.push(that.validateObjectList(o, 'File', 'meeting', !included, 'Meeting'));
                    l.push(that.validateObjectList(o, 'File', 'paper', !included, 'Paper'));
                    l.push(that.validateObjectList(o, 'File', 'agendaItem', !included, 'AgendaItem'));
        ...
        validateConsultation: function(o) {
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    console.log("Validate Consultation object " + o.id + " ...");
                    ...
                    if (o.paper) l.push(that.validatePaper(o.paper));
                    if (o.agendaItem) l.push(that.validateAgendaItem(o.agendaItem));
                    // if (o.meeting) l.push(that.validateMeeting(o.meeting));

                    // l.push(that.validateObjectList(o, 'Consultation', 'organization', false, 'Organization'));
        ...
        validateAgendaItem: function(o) {
            ...
            return new Promise(function(resolve, reject) { 
                o.get().then(o => {
                    ...
                    console.log("Validate AgendaItem object " + o.id + " ...");
                    ...
                    if (o.meeting) l.push(that.validateMeeting(o.meeting));
                    if (o.consultation) l.push(that.validateConsultation(o.consultation));

                    if (o.resolutionFile) l.push(that.validateFile(o.resolutionFile));
                    
                    l.push(that.validateObjectList(o, 'AgendaItem', 'auxiliaryFile', false, 'File'));
